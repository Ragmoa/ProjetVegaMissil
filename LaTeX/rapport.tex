...
\begin{itemize}
    ...
    \item{- 6 Go de RAM:  La capacité en ram est répartie sur 2 unités: une de 4 et une de 2 Go celà nous empéche d'utiliser du dual channel. Deplus les unité sont plutot bas de gamme}
\end{itemize}
