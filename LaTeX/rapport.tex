...
\begin{itemize}
    ...
    \item{- 6 Go de RAM:  La capacité en ram est répartie sur 2 unités: une de 4 et une de 2 Go, celà nous empéche d'utiliser du dual channel. De plus les unité sont plutôt bas de gamme.}
\end{itemize}
