...
Afin de déterminer le nombre de répétitions a utiliser pour nos mesures, nous fixons la taille des données, ainsi que le nombre de méta-répétitions. On regarde alors le temps moyen pour une répétition, pour 4 a 50 répétitions.
\begin{figure}[ht!]
    \centering
    \includegraphics[width=100mm]{MEDIA/rep.png}
    \caption{Temps moyen par répétition pour 4 a 50 répétitions}
\end{figure}

On calcule enfin la médiane en fonction du nombre de répétitions.
On choisit celle-ci, soit 40 répétitions.
\newpage
...
\begin{figure}[ht!]
    ...
    \caption{Temps moyen par méta-répétition pour 4 a 50 méta-répétitions}
\end{figure}
On trouve comme valeur une médiane de: 27 méta-répétitions.
\newpage
