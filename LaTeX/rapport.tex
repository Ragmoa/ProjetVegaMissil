...
\newpage
   \begin{figure}[ht!]
    ...
    \end{figure}
On remarque que icc en fast, génère un code bien plus rapide que gcc.
Cela est du au fait, que bien qu'elle soit activée, gcc ne parvient pas a vectoriser le code, tandis que icc y parvient.
\end{document}
