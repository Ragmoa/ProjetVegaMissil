...
..B1.5:                         # Preds ..B1.5 ..B1.4
        ...
        vmovss    (%rsi,%r12,4), %xmm0                          #16.13
        lea       (%r14,%r14), %r8d                             #16.25
        movslq    %r8d, %r8                                     #16.25
        movslq    %r14d, %rdx                                   #16.4
        incl      %r14d                                         #15.3
        imulq     %r9, %rdx                                     #16.4
        vdivss    (%rcx,%r8,4), %xmm0, %xmm1                    #16.25
        vmovss    %xmm1, (%r15,%rdx,8)                          #16.4
        vmovss    (%rsi,%r12,4), %xmm2                          #16.13
        vdivss    4(%rcx,%r8,4), %xmm2, %xmm3                   #16.25
        vmovss    %xmm3, (%r13,%rdx,8)                          #16.4
        cmpl      %ebp, %r14d                                   #15.3
...
..B1.8:                         # Preds ..B1.7
        ...
        vmovss    (%rsi,%r12,4), %xmm0                          #16.13
        vdivss    -4(%rcx,%r13,4), %xmm0, %xmm1                 #16.25
        imulq     %r10, %r13                                    #16.4
        addq      %r11, %r13                                    #16.4
        vmovss    %xmm1, (%r13,%rbx,4)                          #16.4
                                # LOE rax rdx rcx rbx rsi r8 r9 r10 r11 ebp edi
